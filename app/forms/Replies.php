...
class Forms_Replies extends Form_Model
{
    ...
    protected $validators = [
        'name'                  => ['-strwidth', 'strlen(' . Replies::MAX_NAME_LENGTH . ')'],
        'comment'               => ['-strwidth', 'strlen(' . Replies::MAX_COMMENT_LENGTH . ')'],
        'picture'               => ['-strwidth', 'image("' . (Replies::MAX_PICTURE_SIZE / 1024 / 1024) . 'M")'],
        'color'                 => ['validateColor'],
